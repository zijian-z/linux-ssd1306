...
int main() 
{
    ...
    oled_write_ascii(37, 0, 'W', 6);
    oled_write_ascii(43, 0, 'O', 6);
    oled_write_ascii(49, 0, 'R', 6);
    oled_write_ascii(55, 0, 'L', 6);
    oled_write_ascii(61, 0, 'D', 6);
    // oled_draw_line(0, 0, 127, 0, 0);
    // oled_draw_line(0, 7, 127, 0, 1);
    // oled_draw_line(0, 0, 64, 1, 0);
    // oled_draw_line(127, 0, 64, 1, 0);
    close(file);
    return 0;
}